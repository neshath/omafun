...
export const MARKET_FORMAT='omafun-open-game';
...
export function validateListing(input,{requireProject=true}={}){
 if(!input||input.format!==MARKET_FORMAT||input.version!==1||input.openSource!==true)throw Error('This is not an open-source Omafun package.');
...
export class MarketLibrary{
 constructor(storage=globalThis.localStorage){this.storage=storage;this.key='omafun-library-v1';}
