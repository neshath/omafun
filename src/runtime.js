...
export class Runtime {
  ...
  setCheckpoint(e) {
    ...
    if(!e.active){e.active=true;this.dispatch('checkpoint',e.id);this.notify('checkpoint',{sceneId:this.scene.id,x:e.x,y:e.y});}
    this.checkpointState=clone(this.scene);
    this.sceneStates.set(this.scene.id,clone(this.scene));
